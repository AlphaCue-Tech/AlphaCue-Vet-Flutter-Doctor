                      ...
                      children: [
                        ...
                        ElevatedButton(
                            ...
                            onPressed: () async {
                              ...
                              // String id=d["id"];
                              // var commentsRef2 = FirebaseDatabase.instance.ref("CHATSEEN/$id");
                              // commentsRef2.set({
                              //   "UserSeen": 0,
                              //   "DoctorSeen": 0,
                              //
                              ...
                              final snapshot = await ref.child("CHATSEEN/$id").get();
                              if (snapshot.exists) {
                              ...
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => ChatDetails(widget.id.toString(),d["prescription_id"].toString())),
                              );
