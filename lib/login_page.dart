...
import 'package:alphacue_vet_doc/otp_page.dart';
                        ...
                        Visibility(
                          ...
                          child: SizedBox(
                              ...
                              child:  ElevatedButton(
                                  ...
                                  onPressed: () async{
                                    ...
                                    if(phoneNumber.text.length==11){
                                      ...
                                      if (connectivityResult == ConnectivityResult.mobile) {
                                        ...
                                        try{
                                          print("dsssssssssssss"+sharedpreff.read("serial"));
                                  ...
                                  child: Text("verify".tr,style: TextStyle(color:Theme.of(context).highlightColor, fontSize: 20),)
                              )
                          ),
                        ),
                        Visibility(
...
//
//
//                               labelText: "Phone No ex +8801534561707",
//                               hintText: "Phone No ex +8801534561707",
//
//                               enabledBorder: OutlineInputBorder(
//                                 borderSide: BorderSide(color: Theme.of(context).primaryColor, width: 2.0),
//                                 borderRadius: BorderRadius.all(Radius.circular(20)),
...
//                                 onPressed: (){
//                                   print(phoneNumber.text);
//                                  // AuthenticationRepository.instance.phoneauth(phoneNumber.text);
//
//                                   Navigator.pop(context);
//                                   Navigator.push(
//                                     context,
...
//                                   );
//                                 },
//                                 child: Text("app_next".tr,style: TextStyle(color:Colors.white, fontSize: 20),)
//                             )
//                         ),
//                       ],
//                     ),
